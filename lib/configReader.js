...
for (let configOption in donationAddresses) {
  let percent = global.config.blockUnlocker[configOption]
  let wallet = donationAddresses[configOption][global.config.symbol]
  if (percent && wallet) {
