...
let xmrigdata = new Buffer.alloc('0100fb8e8ac805899323371bb790db19218afd8db8e3755d8b90f39b3d5506a9abce4fa912244500000000ee8146d49fa93ee724deb57d12cbc6c6f3b924d946127c7a97418f9348828f0f02', 'hex')

let cnfasthash = new Buffer.alloc('b542df5b6e7f5f05275c98e7345884e2ac726aeeb07e03e44e0389eb86cd05f0', 'hex')
let xmrigcnletiant0hash = new Buffer.alloc('1b606a3f4a07d6489a1bcd07697bd16696b61c8ae982f61a90160f4e52828a7f', 'hex')
let xmrigcnletiant1hash = new Buffer.alloc('c9fae8425d8688dc236bcdbc42fdb42d376c6ec190501aa84b04a4b4cf1ee122', 'hex')
let xmrigcnletiant2hash = new Buffer.alloc('871fcd6823f6a879bb3f33951c8e8e891d4043880b02dfa1bb3be498b50e7578', 'hex')

let xmrigcnliteletiant0hash = new Buffer.alloc('28a22bad3f93d1408fca472eb5ad1cbe75f21d053c8ce5b3af105a57713e21dd', 'hex')
let xmrigcnliteletiant1hash = new Buffer.alloc('87c4e570653eb4c2b42b7a0d546559452dfab573b82ec52f152b7ff98e79446f', 'hex')
let xmrigcnliteletiant2hash = new Buffer.alloc('b7e78fab22eb19cb8c9c3afe034fb53390321511bab6ab4915cd538a630c3c62', 'hex')

let xmrigcndarkletiant0hash = new Buffer.alloc('bea42eadd78614f875e55bb972aa5ec54a5edf2dd7068220fda26bf4b1080fb8', 'hex')
let xmrigcndarkletiant1hash = new Buffer.alloc('d18cb32bd5b465e5a7ba4763d60f88b5792f24e513306f1052954294b737e871', 'hex')
let xmrigcndarkletiant2hash = new Buffer.alloc('a18a14d94efea108757a42633a1b4d4dc11838084c3c4347850d39ab5211a91f', 'hex')

let xmrigcndarkliteletiant0hash = new Buffer.alloc('faa7884d9c08126eb164814aeba6547b5d6064277a09fb6b414f5dbc9d01eb2b', 'hex')
let xmrigcndarkliteletiant1hash = new Buffer.alloc('c75c010780fffd9d5e99838eb093b37c0dd015101c9d298217866daa2993d277', 'hex')
let xmrigcndarkliteletiant2hash = new Buffer.alloc('fdceb794c1055977a955f31c576a8be528a0356ee1b0a1f9b7f09e20185cda28', 'hex')

let xmrigcnturtleletiant0hash = new Buffer.alloc('546c3f1badd7c1232c7a3b88cdb013f7f611b7bd3d1d2463540fccbd12997982', 'hex')
let xmrigcnturtleletiant1hash = new Buffer.alloc('29e7831780a0ab930e0fe3b965f30e8a44d9b3f9ad2241d67cfbfea3ed62a64e', 'hex')
let xmrigcnturtleletiant2hash = new Buffer.alloc('fc67dfccb5fc90d7855ae903361eabd76f1e40a22a72ad3ef2d6ad27b5a60ce5', 'hex')

let xmrigcnturtleliteletiant0hash = new Buffer.alloc('5e1891a15d5d85c09baf4a3bbe33675cfa3f77229c8ad66c01779e590528d6d3', 'hex')
let xmrigcnturtleliteletiant1hash = new Buffer.alloc('ae7f864a7a2f2b07dcef253581e60a014972b9655a152341cb989164761c180a', 'hex')
let xmrigcnturtleliteletiant2hash = new Buffer.alloc('b2172ec9466e1aee70ec8572a14c233ee354582bcb93f869d429744de5726a26', 'hex')

let cnsoftshellHashv0 = []
cnsoftshellHashv0.push(new Buffer.alloc('5e1891a15d5d85c09baf4a3bbe33675cfa3f77229c8ad66c01779e590528d6d3', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('e1239347694df77cab780b7ec8920ec6f7e48ecef1d8c368e06708c08e1455f1', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('118a03801c564d12f7e68972419303fe06f7a54ab8f44a8ce7deafbc6b1b5183', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('8be48f7955eb3f9ac2275e445fe553f3ef359ea5c065cde98ff83011f407a0ec', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('d33da3541960046e846530dcc9872b1914a62c09c7d732bff03bec481866ae48', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('8be48f7955eb3f9ac2275e445fe553f3ef359ea5c065cde98ff83011f407a0ec', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('118a03801c564d12f7e68972419303fe06f7a54ab8f44a8ce7deafbc6b1b5183', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('e1239347694df77cab780b7ec8920ec6f7e48ecef1d8c368e06708c08e1455f1', 'hex'))
cnsoftshellHashv0.push(new Buffer.alloc('5e1891a15d5d85c09baf4a3bbe33675cfa3f77229c8ad66c01779e590528d6d3', 'hex'))
...
cnsoftshellHashv1.push(new Buffer.alloc('ae7f864a7a2f2b07dcef253581e60a014972b9655a152341cb989164761c180a', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('ce8687bdd08c49bd1da3a6a74bf28858670232c1a0173ceb2466655250f9c56d', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('ddb6011d400ac8725995fb800af11646bb2fef0d8b6136b634368ad28272d7f4', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('02576f9873dc9c8b1b0fc14962982734dfdd41630fc936137a3562b8841237e1', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('d37e2785ab7b3d0a222940bf675248e7b96054de5c82c5f0b141014e136eadbc', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('02576f9873dc9c8b1b0fc14962982734dfdd41630fc936137a3562b8841237e1', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('ddb6011d400ac8725995fb800af11646bb2fef0d8b6136b634368ad28272d7f4', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('ce8687bdd08c49bd1da3a6a74bf28858670232c1a0173ceb2466655250f9c56d', 'hex'))
cnsoftshellHashv1.push(new Buffer.alloc('ae7f864a7a2f2b07dcef253581e60a014972b9655a152341cb989164761c180a', 'hex'))
...
let address = new Buffer.alloc('TRTLuxN6FVALYxeAEKhtWDYNS9Vd9dHVp3QHwjKbo76ggQKgUfVjQp8iPypECCy3MwZVyu89k1fWE2Ji6EKedbrqECHHWouZN6g')

let addressPrefix = cnUtil.Base58.decode(address)
