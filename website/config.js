let api = 'http://poolhost.com:8117'

let api_blockexplorer = 'http://daemonhost.com:11898'

let poolHost = 'poolhost.com'

let irc = 'irc.freenode.net/#poolhost'

let email = 'support@poolhost.com'

let cryptonatorWidget = ['{symbol}-BTC', '{symbol}-USD', '{symbol}-EUR']
